...
<head>
  ...
  <title>Pages / Login -  Amazing India</title>
      ...
      <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
          <div class="row justify-content-center">
            ...
            <div>
                  <img style="width:110px;margin-bottom:0rem;"  src="<?php echo base_url('assets/asset/images/login.png')?>" alt="">
                  </div>
              <div class="d-flex justify-content-center py-0">
              
                <a href="<?php echo base_url();?>" class="logo d-flex align-items-center w-auto">
                 
                  <img style="width:300px;margin-bottom:1rem;"  src="<?php echo base_url('assets/asset/images/logoo.png')?>" alt="">
                  <!-- <span class="d-none d-lg-block">BSLA</span> -->
                </a>
              </div><!-- End Logo -->
